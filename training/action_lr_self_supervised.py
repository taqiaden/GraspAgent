...
class TrainActionNet:
    ...
    def prepare_data_loader(self):
        file_ids = sample_positive_buffer(size=self.n_samples, dict_name=gripper_grasp_tracker,
                                          disregard_collision_samples=False,sample_with_probability=False)
    ...
    def begin(self):
        ...
        for i, batch in enumerate(self.data_loader, 0):
            ...
            with torch.no_grad():
                ...
                # bin_mask = bin_planes_detection(pc, sides_threshold=0.0035, floor_threshold=0.002, view=True,
