...
shift_model_state_path=r'shift_model_state'
...
class ShiftNet(nn.Module):
    def __init__(self):
        ...
        self.res_block= res_block_mlp_LN(in_c=64,medium_c=32,out_c=16,activation=nn.ReLU(True)).to('cuda')
    ...
    def forward(self, depth ):
        ...
        '''decode'''
        output_2d = self.decoder(self.res_block(depth_features_2d))
